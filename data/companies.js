...
const companiesRaw = {
  ...
  google: {
    ...
    color: '#4285F4', broker: 'morgan_stanley', vestCycle: 'Quarterly', analystTarget: '$210', hasLogo: true,
    ...
    seoTitle: 'Google RSU India — Move GOOGL to Rovia | Rovia',
  ...
  meta: {
    ...
    seoTitle: 'Meta RSU India — Move META to Rovia | Rovia',
  ...
  microsoft: {
    ...
    color: '#00A4EF', broker: 'fidelity', vestCycle: 'Quarterly (Feb, May, Aug, Nov)', analystTarget: '$510', hasLogo: true,
    ...
    seoTitle: 'Microsoft RSU India — Move MSFT to Rovia | Rovia',
  ...
  amazon: {
    ...
    color: '#FF9900', broker: 'morgan_stanley', vestCycle: 'Back-weighted: 5%–15%–40%–40% over 4 years', analystTarget: '$250', hasLogo: true,
    ...
    seoTitle: 'Amazon RSU India — Move AMZN to Rovia | Rovia',
  ...
  apple: {
    ...
    seoTitle: 'Apple RSU India — Move AAPL to Rovia | Rovia',
  ...
  netflix: {
    ...
    seoTitle: 'Netflix RSU India — Move NFLX to Rovia | Rovia',
  ...
  salesforce: {
    ...
    seoTitle: 'Salesforce RSU India — Move CRM to Rovia | Rovia',
  ...
  servicenow: {
    ...
    seoTitle: 'ServiceNow RSU India — Move NOW to Rovia | Rovia',
  ...
  paypal: {
    ...
    seoTitle: 'PayPal RSU India — Move PYPL to Rovia | Rovia',
  ...
  uber: {
    ...
    seoTitle: 'Uber RSU India — Move UBER to Rovia | Rovia',
  ...
  adobe: {
    ...
    seoTitle: 'Adobe RSU India — Move ADBE to Rovia | Rovia',
  ...
  oracle: {
    ...
    seoTitle: 'Oracle RSU India — Move ORCL to Rovia | Rovia',
  ...
  intuit: {
    ...
    seoTitle: 'Intuit RSU India — Move INTU to Rovia | Rovia',
  ...
  intel: {
    ...
    seoTitle: 'Intel RSU India — Move INTC to Rovia | Rovia',
  ...
  amdocs: {
    ...
    seoTitle: 'Amdocs RSU India — Move DOX to Rovia | Rovia',
  ...
  autodesk: {
    ...
    seoTitle: 'Autodesk RSU India — Move ADSK to Rovia | Rovia',
  ...
  datadog: {
    ...
    seoTitle: 'Datadog RSU India — Move DDOG to Rovia | Rovia',
  ...
  fortinet: {
    ...
    seoTitle: 'Fortinet RSU India — Move FTNT to Rovia | Rovia',
  ...
  honeywell: {
    ...
    seoTitle: 'Honeywell RSU India — Move HON to Rovia | Rovia',
  ...
  hubspot: {
    ...
    seoTitle: 'HubSpot RSU India — Move HUBS to Rovia | Rovia',
  ...
  'juniper-networks': {
    ...
    seoTitle: 'Juniper Networks RSU India — Move to Rovia | Rovia',
  ...
  'lam-research': {
    ...
    seoTitle: 'Lam Research RSU India — Move LRCX to Rovia | Rovia',
  ...
  'eli-lilly': {
    ...
    seoTitle: 'Eli Lilly RSU India — Move LLY to Rovia | Rovia',
  ...
  marvell: {
    ...
    seoTitle: 'Marvell RSU India — Move MRVL to Rovia | Rovia',
  ...
  mongodb: {
    ...
    seoTitle: 'MongoDB RSU India — Move MDB to Rovia | Rovia',
  ...
  'new-relic': {
    ...
    seoTitle: 'New Relic RSU India — Manage with Rovia | Rovia',
  ...
  okta: {
    ...
    seoTitle: 'Okta RSU India — Move OKTA to Rovia | Rovia',
  ...
  snowflake: {
    ...
    seoTitle: 'Snowflake RSU India — Move SNOW to Rovia | Rovia',
  ...
  splunk: {
    ...
    seoTitle: 'Splunk RSU India — Manage with Rovia | Rovia',
  ...
  'texas-instruments': {
    ...
    seoTitle: 'Texas Instruments RSU India — TXN on Rovia | Rovia',
  ...
  amd: {
    ...
    color: '#ED1C24', broker: 'etrade', vestCycle: 'Quarterly', analystTarget: '$170', hasLogo: true,
    ...
    seoTitle: 'AMD RSU India — Move AMD to Rovia | Rovia',
  ...
  'arista-networks': {
    ...
    seoTitle: 'Arista Networks RSU India — Move ANET to Rovia | Rovia',
  ...
  arm: {
    ...
    color: '#009FE3', broker: 'fidelity', vestCycle: 'Quarterly', analystTarget: '$120', hasLogo: true,
    ...
    seoTitle: 'Arm Holdings RSU India — Move ARM to Rovia | Rovia',
  ...
  cadence: {
    ...
    seoTitle: 'Cadence RSU India — Move CDNS to Rovia | Rovia',
  ...
  cloudflare: {
    ...
    seoTitle: 'Cloudflare RSU India — Move NET to Rovia | Rovia',
  ...
  confluent: {
    ...
    seoTitle: 'Confluent RSU India — Move CFLT to Rovia | Rovia',
  ...
  freshworks: {
    ...
    seoTitle: 'Freshworks RSU India — Move FRSH to Rovia | Rovia',
  ...
  netapp: {
    ...
    seoTitle: 'NetApp RSU India — Move NTAP to Rovia | Rovia',
  ...
  pegasystems: {
    ...
    seoTitle: 'Pegasystems RSU India — Move PEGA to Rovia | Rovia',
  ...
  rubrik: {
    ...
    seoTitle: 'Rubrik RSU India — Move RBRK to Rovia | Rovia',
  ...
  sentinelone: {
    ...
    seoTitle: 'SentinelOne RSU India — Move to Rovia | Rovia',
  ...
  sprinklr: {
    ...
    seoTitle: 'Sprinklr RSU India — Move CXM to Rovia | Rovia',
  ...
  synopsys: {
    ...
    seoTitle: 'Synopsys RSU India — Move SNPS to Rovia | Rovia',
  ...
  target: {
    ...
    seoTitle: 'Target RSU India — Move TGT to Rovia | Rovia',
  ...
  twilio: {
    ...
    seoTitle: 'Twilio RSU India — Move TWLO to Rovia | Rovia',
  ...
  visa: {
    ...
    seoTitle: 'Visa RSU India — Move V to Rovia | Rovia',
  ...
  zscaler: {
    ...
    seoTitle: 'Zscaler RSU India — Move ZS to Rovia | Rovia',
