...
export const stories = [
  {
    ...
    tag: 'Schedule FA',
    tagColor: '#a78bfa',
    teaser: 'Spent every July rebuilding cost basis from scratch. Not anymore.',
    stats: [
      { label: 'Rovia user since', value: 'Jan 2024' },
...

  {
    ...
    tag: 'FX Cost',
    tagColor: '#34d399',
    teaser: '₹2.2 lakh lost to FX markup over 5 years. She never noticed until she looked.',
    stats: [
      { label: 'Rovia user since', value: 'Feb 2024' },
...

  {
    ...
    stats: [
      { label: 'Rovia user since', value: 'Mar 2024' },
...

  {
    ...
    tag: 'Lot Tracking',
    tagColor: '#60a5fa',
    teaser: '48 lots. 48 INR cost bases. Her spreadsheet eventually broke — as expected.',
    stats: [
      { label: 'Rovia user since', value: 'Apr 2024' },
...

  {
    ...
    tagColor: '#f43f5e',
    teaser: '₹58L in META, zero in anything else. He knew it was a problem. Kept deferring.',
    stats: [
      { label: 'Rovia user since', value: 'Jun 2024' },
...

  {
    ...
    tag: 'FX Cost',
    tagColor: '#34d399',
    teaser: 'Apple vests quarterly. She was repatriating every time. The cost was invisible.',
    stats: [
      { label: 'Rovia user since', value: 'May 2024' },
...

  {
    ...
    tag: 'LTCG Timing',
    tagColor: '#f59e0b',
    teaser: 'NVDA went up 5x while he was figuring out what to do with it.',
    stats: [
      { label: 'Rovia user since', value: 'Jul 2024' },
      { label: 'Years vested', value: '5 years' },
...

  {
    ...
    tag: 'First RSU',
    tagColor: '#c084fc',
    teaser: 'First vest landed. Nobody told her what Schedule FA was.',
    stats: [
      { label: 'Rovia user since', value: 'Aug 2024' },
...

  {
    ...
    tag: 'Switching Jobs',
    tagColor: '#fb923c',
    teaser: 'Left Amazon after 4 years. Needed his RSU records clean before day one at the startup.',
    stats: [
      { label: 'Rovia user since', value: 'Sep 2023' },
...

  {
    ...
    tag: 'Lot Tracking',
    tagColor: '#60a5fa',
    teaser: 'She\'s a designer. She shouldn\'t need to understand SBI TT rates to file her taxes.',
    stats: [
      { label: 'Rovia user since', value: 'Oct 2023' },
      { label: 'Years vested', value: '3 years' },
...

  {
    ...
    tag: 'FX Cost',
    tagColor: '#34d399',
    teaser: 'Sends money to parents every quarter. FX was hitting him on both legs of the transfer.',
    stats: [
      { label: 'Rovia user since', value: 'Nov 2023' },
      { label: 'Years vested', value: '5 years' },
...

  {
    ...
    tag: 'Schedule FA',
    tagColor: '#a78bfa',
    teaser: 'Uber\'s stock is volatile. His Schedule FA situation was more volatile.',
    stats: [
      { label: 'Rovia user since', value: 'Feb 2024' },
...

  {
    ...
    tag: 'Lot Tracking',
    tagColor: '#60a5fa',
    teaser: 'Six months of maternity leave. Two vests happened. Nobody told her what to do next.',
    stats: [
      { label: 'Rovia user since', value: 'Mar 2024' },
...

  {
    ...
    tag: 'Schedule FA',
    tagColor: '#a78bfa',
    teaser: 'Qualcomm isn\'t in the FAANG conversation. His compliance obligations were identical.',
    stats: [
      { label: 'Rovia user since', value: 'May 2024' },
...

  {
    ...
    stats: [
      { label: 'Rovia user since', value: 'Aug 2023' },
...

  {
    ...
    stats: [
      { label: 'Rovia user since', value: 'Sep 2024' },
      { label: 'Years vested', value: '4 years' },
...

  {
    ...
    stats: [
      { label: 'Rovia user since', value: 'Oct 2024' },
      { label: 'Years vested', value: '3 years' },
...

  {
    ...
    stats: [
      { label: 'Rovia user since', value: 'Nov 2024' },
      { label: 'Years vested', value: '4 years' },
      { label: 'Lots tracked', value: '16 lots' },
